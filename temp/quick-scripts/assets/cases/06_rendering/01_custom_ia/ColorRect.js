(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/cases/06_rendering/01_custom_ia/ColorRect.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'fba8045Ab5Jn4yj2EBO8nRt', 'ColorRect', __filename);
// cases/06_rendering/01_custom_ia/ColorRect.js
...
var ColorRect = cc.Class({
    ...
    _createIA: function _createIA() {
        ...
        this._vertexFormat = new gfx.VertexFormat([{ name: gfx.ATTR_POSITION, type: gfx.ATTR_TYPE_FLOAT32, num: 2 }, { name: gfx.ATTR_COLOR, type: gfx.ATTR_TYPE_UINT8, num: 4, normalize: true }]);
        ...
        this._vb = new gfx.VertexBuffer(device, this._vertexFormat, gfx.USAGE_DYNAMIC,
        // array buffer with real data
        null,
        // vertex count
        4);
        this._ib = new gfx.IndexBuffer(device, gfx.INDEX_FMT_UINT16, gfx.USAGE_STATIC, this._iData,
        // index count
        this._iData.length);
    ...
    update: function update() {
        this.node.getWorldMatrix(_currMat);
        if (_currMat.m00 !== _prevMat.m00 || _currMat.m01 !== _prevMat.m01 || _currMat.m04 !== _prevMat.m04 || _currMat.m05 !== _prevMat.m05 || _currMat.m12 !== _prevMat.m12 || _currMat.m13 !== _prevMat.m13) {
            this._updateVertexData(_currMat);
        }
    }
});
