    ...
    cc.Class({
        ...
        _updateAim: function _updateAim() {
            ...
            if (this._aimDir != aimDir) {
                ...
                // Animation mixing.
                if (this._aimDir >= 0) {
                    this._aimState = this._armature.animation.fadeIn("aimUp", 0.01, 1, 0, AIM_ANIMATION_GROUP, dragonBones.AnimationFadeOutMode.SameGroup);
                } else {
                    this._aimState = this._armature.animation.fadeIn("aimDown", 0.01, 1, 0, AIM_ANIMATION_GROUP, dragonBones.AnimationFadeOutMode.SameGroup);
                }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=DragonBonesCtrl.js.map
